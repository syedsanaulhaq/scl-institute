                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Choose the perfect theme for your college website</p>
                            </div>
                        </div>
                        <button
                            onClick={handleApplyTheme}
                            className={`bg-${theme.primary} text-white px-8 py-3 rounded-lg font-semibold hover:bg-${theme.secondary} transition-colors`}
                        >
                            Use This Theme
                        </button>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                        ...
                        {Object.entries(themes).map(([key, themeData]) => (
                            <button
                                ...
                                className={`p-6 rounded-xl border-2 transition-all text-left hover:shadow-lg ${
                                    selectedTheme === key
                                        ? `border-${themeData.primary} bg-${themeData.primary}/5`
                                        : 'border-gray-200 hover:border-gray-300'
                                }`}
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <h3 className="text-lg font-bold text-gray-900">{themeData.name}</h3>
                                    <div className={`w-12 h-8 bg-gradient-to-r ${themeData.gradient} rounded`}></div>
                                </div>
                                <p className="text-gray-600 text-sm mb-4">{themeData.description}</p>
                                <div className="flex items-center space-x-2">
                                    <div className={`w-4 h-4 bg-${themeData.primary} rounded-full`}></div>
                                    <div className={`w-4 h-4 bg-${themeData.secondary} rounded-full`}></div>
                                    <div className={`w-4 h-4 bg-${themeData.accent} rounded-full`}></div>
                                </div>
                            </button>
                        ))}
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="bg-gray-800 px-6 py-3 flex items-center space-x-2">
                        ...
                        <div className="flex-1 text-center">
                            <span className="text-white text-sm">Live Preview - {theme.name}</span>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <nav className="bg-white shadow-sm">
                            <div className="px-6 py-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        <div className={`p-2 rounded-xl bg-${theme.primary}`}>
                                            <GraduationCap className="h-6 w-6 text-white" />
                                        </div>
                                        <div>
                                            <h1 className="text-lg font-bold text-gray-900">SCL Institute</h1>
                                            <p className="text-xs text-gray-600">Excellence in Education</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center space-x-6">
                                        <a href="#" className={`text-gray-700 hover:text-${theme.primary} text-sm`}>Home</a>
                                        <a href="#" className={`text-gray-700 hover:text-${theme.primary} text-sm`}>Programs</a>
                                        <a href="#" className={`text-gray-700 hover:text-${theme.primary} text-sm`}>About</a>
                                        <button className={`bg-${theme.accent} text-white px-4 py-2 rounded-full text-sm font-semibold`}>
                                            Apply Now
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className="relative h-64 overflow-hidden">
                            ...
                            <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-6">
                                <div>
                                    ...
                                    <p className={`text-${theme.accent} text-lg font-serif mb-4`}>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                                        <button className={`bg-${theme.accent} text-white px-6 py-2 rounded-full text-sm font-semibold`}>
                                            Explore Programs
                                        </button>
                                        <button className="border border-white text-white px-6 py-2 rounded-full text-sm font-semibold">
                                            Virtual Tour
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className={`py-12 bg-gradient-to-r ${theme.gradient} text-white`}>
                            <div className="px-6">
                                <div className="grid grid-cols-4 gap-8 text-center">
                                    <div>
                                        <Users className={`h-8 w-8 mx-auto mb-2 text-${theme.accent}`} />
                                        <div className="text-xl font-bold">15,000+</div>
                                        <div className="text-sm opacity-90">Students</div>
                                    </div>
                                    <div>
                                        <GraduationCap className={`h-8 w-8 mx-auto mb-2 text-${theme.accent}`} />
                                        <div className="text-xl font-bold">500+</div>
                                        <div className="text-sm opacity-90">Faculty</div>
                                    </div>
                                    <div>
                                        <BookOpen className={`h-8 w-8 mx-auto mb-2 text-${theme.accent}`} />
                                        <div className="text-xl font-bold">50+</div>
                                        <div className="text-sm opacity-90">Programs</div>
                                    </div>
                                    <div>
                                        <Award className={`h-8 w-8 mx-auto mb-2 text-${theme.accent}`} />
                        ...
                        <div className={`py-12 ${theme.bgPattern}`}>
                            <div className="px-6">
                                <div className="text-center mb-8">
                                    <h3 className="text-2xl font-bold text-gray-900 mb-3">Our Programs</h3>
                                    <p className="text-gray-600">Discover world-class programs designed for success</p>
                                </div>
                                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    {[
                                        { name: 'Computer Science', type: 'B.Tech', duration: '4 Years' },
                                        { name: 'Business Admin', type: 'MBA', duration: '2 Years' },
                                        { name: 'Data Science', type: 'M.Sc', duration: '2 Years' }
                                    ].map((program, index) => (
                                        <div key={index} className="bg-white rounded-lg shadow p-4">
                                            <div className="flex items-center justify-between mb-3">
                                                <span className={`bg-${theme.primary} text-white px-2 py-1 rounded text-xs font-semibold`}>
                                                    {program.type}
                                                </span>
                                                <span className="text-gray-500 text-xs">{program.duration}</span>
                                            </div>
                                            <h4 className="font-bold text-gray-900 mb-2">{program.name}</h4>
                                            <button className={`w-full bg-${theme.primary} text-white py-2 rounded text-sm font-semibold`}>
                                                Learn More
                                            </button>
                                        </div>
                                    ))}
                        ...
                        {/* Apply Now Section Preview */}
                        <div className={`py-12 bg-gradient-to-r ${theme.gradient} text-white text-center`}>
                            <div className="px-6">
                                <h3 className="text-2xl font-bold mb-3">Ready to Start Your Journey?</h3>
                                <p className="text-white/90 mb-6">Take the first step towards your bright future</p>
                                <button className={`bg-${theme.accent} text-white px-8 py-3 rounded-full text-lg font-bold hover:opacity-90 transition-opacity`}>
                                    Apply Now - It's Free!
                                </button>
                            </div>
                        </div>
                ...
                <div className="mt-8 text-center">
                    <div className="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto">
                        <div className={`w-16 h-16 bg-gradient-to-r ${theme.gradient} rounded-full flex items-center justify-center mx-auto mb-4`}>
                        ...
                        <button
                            onClick={handleApplyTheme}
                            className={`bg-${theme.primary} text-white px-8 py-3 rounded-lg font-semibold hover:bg-${theme.secondary} transition-colors w-full`}
                        >
                            Continue with {theme.name}
                        </button>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="fixed top-4 right-4 z-50 bg-white rounded-lg shadow-lg p-4">
                <h3 className="font-bold mb-2">Choose Theme:</h3>
                    ...
                    {Object.entries(themes).map(([key, themeData]) => (
                        <button
                            ...
                            className={`w-full text-left px-3 py-2 rounded text-sm ${
                                selectedTheme === key ? 'bg-blue-100 text-blue-800' : 'hover:bg-gray-100'
                            }`}
                        >
                            {themeData.name}
                        </button>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            <button className={`bg-${theme.accent} text-white px-6 py-2 rounded-full font-semibold hover:opacity-90 transition-opacity`}>
                                Apply Now
                            </button>
                        </div>
                    </div>
            ...
            <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button className={`bg-${theme.accent} text-white px-8 py-4 rounded-full text-lg font-semibold hover:opacity-90 transition-all duration-300 transform hover:scale-105 flex items-center justify-center`}>
                            Explore Programs
            ...
            <section className={`py-20 bg-gradient-to-r ${theme.gradient} text-white`}>
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <button className={`bg-${theme.accent} text-white px-12 py-4 rounded-full text-xl font-bold hover:opacity-90 transition-all duration-300 transform hover:scale-105`}>
                        Apply Now - It's Free!
                    </button>
                </div>
            </section>
