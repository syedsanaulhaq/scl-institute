    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-2">Only subjects where you are assigned as faculty are shown here.</p>
            </div>
            ...
            {courses.length === 0 ? (
                <div className="bg-white rounded-lg shadow p-8 text-center">
                    ...
                    <p className="text-sm text-gray-500 mt-1">Please contact admin if your faculty role assignments are missing.</p>
                </div>
            ) : (
