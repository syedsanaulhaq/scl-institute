                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="bg-white rounded-xl border shadow-sm p-4" style={{ borderColor: '#E5E7EB' }}>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {[
                                { icon: '=ƒô¥', label: 'Assessments', path: '/student/assessments' },
                                { icon: '=ƒôä', label: 'My Programme', path: '/student/programme' },
                                { icon: '=ƒÅå', label: 'Grades', path: '/student/grades' },
                                { icon: '=ƒôà', label: 'Timetable', path: '/student/timetable' },
                                { icon: '=ƒôÜ', label: 'Library', path: '/student/library' },
                                { icon: '=ƒÆ¼', label: 'Messages', path: '/student/messages', badge: unreadMessages > 0 ? unreadMessages : null },
                            ].map((item, i) => (
                                <button
                                    key={i}
