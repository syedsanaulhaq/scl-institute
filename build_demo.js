...
.video-responsive{position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:12px;border:1px solid rgba(255,255,255,0.1);background:#000}
.video-responsive iframe{position:absolute;top:0;left:0;width:100%;height:100%;border:0}
.video-fallback{margin-top:0.75rem;text-align:center}
.video-fallback a{color:#f59e0b;text-decoration:none;font-size:0.85rem;font-weight:500}
.video-fallback a:hover{text-decoration:underline}
.video-card{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1.5rem;background:linear-gradient(135deg,rgba(217,119,6,0.12),rgba(15,23,42,0.9));border:1px solid rgba(217,119,6,0.35);border-radius:16px;padding:3rem 2rem;text-align:center}
.video-play-icon{width:80px;height:80px;border-radius:50%;background:linear-gradient(135deg,#d97706,#f59e0b);display:flex;align-items:center;justify-content:center;box-shadow:0 0 30px rgba(217,119,6,0.5);transition:transform 0.2s,box-shadow 0.2s}
.video-play-icon:hover{transform:scale(1.08);box-shadow:0 0 45px rgba(217,119,6,0.7)}
.video-play-icon svg{width:32px;height:32px;fill:#fff;margin-left:4px}
.video-card-title{font-size:1.2rem;font-weight:700;color:#f8fafc;margin:0}
.video-card-sub{font-size:0.9rem;color:#94a3b8;margin:0}
.video-watch-btn{display:inline-flex;align-items:center;gap:0.5rem;padding:0.75rem 2rem;background:linear-gradient(135deg,#d97706,#f59e0b);color:#fff;font-weight:700;font-size:0.95rem;border-radius:50px;text-decoration:none;box-shadow:0 4px 15px rgba(217,119,6,0.4);transition:transform 0.2s,box-shadow 0.2s}
.video-watch-btn:hover{transform:translateY(-2px);box-shadow:0 6px 20px rgba(217,119,6,0.6)}
</style>
</head>
<body>
...
${roleSection(
  ...
  `<div class="video-embed-block">
    <h3>🎬 System Walkthrough Video</h3>
    <div class="video-card">
      <a href="https://1drv.ms/v/c/36c4c677baf25368/IQDrf1uIiby-SLB3jifgL1tfAemncrzgXo4CqcACe3Qgq4M?e=trqK9M" target="_blank" rel="noopener noreferrer" class="video-play-icon">
        <svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
      </a>
      <p class="video-card-title">SCL Institute — Full System Walkthrough</p>
      <p class="video-card-sub">College Admin Portal · Admissions · Student Management · LMS</p>
      <a href="https://1drv.ms/v/c/36c4c677baf25368/IQDrf1uIiby-SLB3jifgL1tfAemncrzgXo4CqcACe3Qgq4M?e=trqK9M" target="_blank" rel="noopener noreferrer" class="video-watch-btn">
        ▶ Watch Video
      </a>
    </div>
  </div>`
