...
<section class="slide bg-hero" id="cover" style="min-height:100vh">
  ...
  <div class="slide-inner">
    <div style="max-width:780px">
      ...
      <h1 class="mega">The <span class="grad">Complete Platform</span><br>for Schools, Colleges, Universities &amp; Institutes</h1>
      ...
      <div style="display:inline-flex;align-items:center;gap:.5rem;padding:.6rem 1rem;border-radius:999px;background:rgba(59,130,246,.12);border:1px solid rgba(59,130,246,.28);color:#bfdbfe;font-size:.82rem;font-weight:700;margin-bottom:1rem">
        Built for schools, colleges, universities, and institutes
      </div>
      <div class="stats-row">
...
<section class="slide bg-hero fade-up" style="padding:100px 40px;min-height:80vh">
  ...
  <div class="slide-inner" style="text-align:center">
    ...
    <p class="lead" style="margin:0 auto 0.5rem;text-align:center;font-size:1.15rem">
      The system is live and running now — not a mockup, not a prototype. It is built for schools, colleges, universities, and institutes. Log in and explore every feature today.
    </p>
