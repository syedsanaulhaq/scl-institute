YUI.add('moodle-theme_learningzone-positionChanger', function(Y) {
	...
	M.theme_learningzone = M.theme_learningzone || {};
	
	M.theme_learningzone.initPositionChanger = function (cfg){
